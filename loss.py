...
class YoloLoss(nn.Module):
    ...
    def forward(self,predictions,target):
        ...
        iou_anch_1=intersection_over_union(predictions[...,21:25],target[...,21:25])
        iou_anch_2=intersection_over_union(predictions[...,26:30],target[...,21:25])
        ...
        #    Loss For Object   #
        # ==================== #
        obj_pred_box=exists_box*(bestbox*predictions[...,25:26] +(1-bestbox)*predictions[...,20:21])
        ...
        #  Loss For No Object  #
        # ==================== #
        no_obj_pred_box_1=(1-exists_box)*predictions[...,20:21] 
        no_obj_pred_box_2=(1-exists_box)*predictions[...,25:26] 
        ...
        #    Loss For Class    #
        # ==================== #
        pred_class=exists_box*predictions[...,:20]
